...
class NotFound extends Component {
    render() {
        return (
            <div>
              <link rel="stylesheet" type="text/css" href={`${contextPath}/assets/css/NotFound.css`} />
        ...
        <div className="container">
          <div className="left-section">
            <div className="inner-content text-center">
              ...
              <p className="subheading">Trang bạn muốn đến không tồn tại hoặc đã bị gỡ bỏ.</p>
              <NavLink to="/">
                <div className="btn btn-outline-light mt-3">TRANG CHỦ</div>
              </NavLink>
            </div>
          </div>
